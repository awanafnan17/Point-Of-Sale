...
return [
    ...
    "copyrights"                     => "Copyright © Afnan 2025",
    ...
    "software_short"                 => "Afnan's POS",
    "software_title"                 => "Afnan's POS",
    "state"                          => "Province",
    "submit"                         => "Submit",
    ...
    "website"                        => "",
    "welcome"                        => "Welcome",
    "welcome_message"                => "Welcome to Afnan's POS, click a module below to get started.",
    "yes"                            => "Yes",
    "you_are_using_ospos"            => "You are using Afnan's POS version",
    "zip"                            => "Postal Code",
];
