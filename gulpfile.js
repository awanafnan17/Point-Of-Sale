...
gulp.task('update-licenses', function () {
    ...
    return pipeline(gulp.src('LICENSE', { allowEmpty: true }), gulp.dest('public/license'));
});
...
gulp.task('debug-js', function () {
    var debugjs = gulp.src(['./node_modules/jquery/dist/jquery.js*',
        ...
        './public/js/nominatim.autocomplete.js*'], { allowEmpty: true }).pipe(rev()).pipe(gulp.dest('public/resources/js'));
    return gulp.src('./app/Views/partial/header.php', { allowEmpty: true }).pipe(inject(debugjs, { addRootSlash: false, ignorePath: '/public/', starttag: '<!-- inject:debug:js -->' })).pipe(gulp.dest('./app/Views/partial'));
});

gulp.task('prod-js', function () {

    var prod0js = gulp.src('./node_modules/jquery/dist/jquery.min.js*', { allowEmpty: true, ignore: ['**/*.map'] }).pipe(rev()).pipe(gulp.dest('public/resources'));
    ...
    var opensourcepos1js = gulp.src(['./node_modules/bootstrap/dist/js/bootstrap.min.js',
        ...
        './node_modules/tableexport.jquery.plugin/tableExport.min.js*'], { allowEmpty: true, ignore: ['**/*.map', '**/*.json', '**/*.txt', '**/*.md'] });
    ...
    return gulp.src('./app/Views/partial/header.php', { allowEmpty: true }).pipe(inject(
...
gulp.task('debug-css', function () {
    ...
    ], { allowEmpty: true }).pipe(rev()).pipe(gulp.dest('public/resources/css'));
    return gulp.src('./app/Views/partial/header.php', { allowEmpty: true }).pipe(inject(debugcss, { addRootSlash: false, ignorePath: '/public/', starttag: '<!-- inject:debug:css -->' })).pipe(gulp.dest('./app/Views/partial'));
});
...
gulp.task('prod-css', function () {
    var opensourcepos1css = gulp.src(['./node_modules/jquery-ui-dist/jquery-ui.min.css',
        ...
        './node_modules/bootstrap-datetime-picker/css/bootstrap-datetimepicker.min.css*'], { allowEmpty: true, ignore: ['**/*.map'] });

    var opensourcepos2css = gulp.src(['./node_modules/bootstrap-daterangepicker/daterangepicker.css*',
        './node_modules/bootstrap-tagsinput-2021/src/bootstrap-tagsinput.css*'], { allowEmpty: true, ignore: ['**/*.map'] }).pipe(cleanCSS({ compatibility: 'ie8' }));
    ...
    var opensourcepos3css = gulp.src(['./node_modules/bootstrap-select/dist/css/bootstrap-select.min.css',
        ...
        './node_modules/chartist/dist/chartist.min.css*'], { allowEmpty: true, ignore: ['**/*.map'] });

    var opensourcepos4css = gulp.src('./node_modules/chartist-plugin-tooltips/dist/chartist-plugin-tooltip.css*', { allowEmpty: true, ignore: ['**/*.map'] }).pipe(cleanCSS({ compatibility: 'ie8' }));
    ...
    var opensourcepos5css = gulp.src(['./node_modules/chartist-plugin-tooltips/dist/chartist-plugin-tooltip.css',
        ...
        './public/css/register.css',
        './public/css/reports.css*'
    ], { allowEmpty: true, ignore: ['**/*.map'] }).pipe(cleanCSS({ compatibility: 'ie8' }));
    ...
    return gulp.src('./app/Views/partial/header.php', { allowEmpty: true }).pipe(inject(prodcss, { addRootSlash: false, ignorePath: '/public/', starttag: '<!-- inject:prod:css -->' })).pipe(gulp.dest('./app/Views/partial'));
});
...
gulp.task('copy-menubar', function () {
    pipeline(gulp.src("./node_modules/elegant-circles/svg/full-color/star.svg*", { allowEmpty: true }), rename("attributes.svg"), gulp.dest("public/images/menubar"));
    pipeline(gulp.src("./node_modules/elegant-circles/svg/full-color/bookshelf.svg*", { allowEmpty: true }), rename("cashups.svg"), gulp.dest("public/images/menubar"));
    pipeline(gulp.src("./node_modules/elegant-circles/svg/full-color/gear.svg*", { allowEmpty: true }), rename("config.svg"), gulp.dest("public/images/menubar"));
    pipeline(gulp.src("./node_modules/elegant-circles/svg/full-color/contacts.svg*", { allowEmpty: true }), rename("customers.svg"), gulp.dest("public/images/menubar"));
    pipeline(gulp.src("./node_modules/elegant-circles/svg/full-color/profle.svg*", { allowEmpty: true }), rename("employees.svg"), gulp.dest("public/images/menubar"));
    pipeline(gulp.src("./node_modules/elegant-circles/svg/full-color/compose.svg*", { allowEmpty: true }), rename("expenses.svg"), gulp.dest("public/images/menubar"));
    pipeline(gulp.src("./node_modules/elegant-circles/svg/full-color/clipboard.svg*", { allowEmpty: true }), rename("expenses_categories.svg"), gulp.dest("public/images/menubar"));
    pipeline(gulp.src("./node_modules/elegant-circles/svg/full-color/heart.svg*", { allowEmpty: true }), rename("giftcards.svg"), gulp.dest("public/images/menubar"));
    pipeline(gulp.src("./node_modules/elegant-circles/svg/full-color/door.svg*", { allowEmpty: true }), rename("home.svg"), gulp.dest("public/images/menubar"));
    pipeline(gulp.src("./node_modules/elegant-circles/svg/full-color/stack.svg*", { allowEmpty: true }), rename("item_kits.svg"), gulp.dest("public/images/menubar"));
    pipeline(gulp.src("./node_modules/elegant-circles/svg/full-color/shop.svg*", { allowEmpty: true }), rename("items.svg"), gulp.dest("public/images/menubar"));
    pipeline(gulp.src("./node_modules/elegant-circles/svg/full-color/smartphone.svg*", { allowEmpty: true }), rename("messages.svg"), gulp.dest("public/images/menubar"));
    pipeline(gulp.src("./node_modules/elegant-circles/svg/full-color/tools.svg*", { allowEmpty: true }), rename("migrate.svg"), gulp.dest("public/images/menubar"));
    pipeline(gulp.src("./node_modules/elegant-circles/svg/full-color/door.svg*", { allowEmpty: true }), rename("office.svg"), gulp.dest("public/images/menubar"));
    pipeline(gulp.src("./node_modules/elegant-circles/svg/full-color/dolly.svg*", { allowEmpty: true }), rename("receivings.svg"), gulp.dest("public/images/menubar"));
    pipeline(gulp.src("./node_modules/elegant-circles/svg/full-color/bar-chart.svg*", { allowEmpty: true }), rename("reports.svg"), gulp.dest("public/images/menubar"));
    pipeline(gulp.src("./node_modules/elegant-circles/svg/full-color/cart.svg*", { allowEmpty: true }), rename("sales.svg"), gulp.dest("public/images/menubar"));
    pipeline(gulp.src("./node_modules/elegant-circles/svg/full-color/briefcase.svg*", { allowEmpty: true }), rename("suppliers.svg"), gulp.dest("public/images/menubar"));
    return pipeline(gulp.src('./node_modules/elegant-circles/svg/full-color/money.svg*', { allowEmpty: true }), rename("taxes.svg"), gulp.dest("public/images/menubar"));
});
...
gulp.task('test-css', function () {
    console.log('Starting test-css task...');
    return gulp.src('./public/css/ospos.css')
        .pipe(gulp.dest('public/resources/css'))
        .on('end', function () { console.log('Finished test-css task.'); });
});

gulp.task('test-css-wildcard', function () {
    console.log('Starting test-css-wildcard task...');
    return gulp.src('./public/css/ospos.c*')
        .pipe(gulp.dest('public/resources/css'))
        .on('end', function () { console.log('Finished test-css-wildcard task.'); });
});
